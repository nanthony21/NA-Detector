...
class FittingWidget(QFrame):
    ...
    def setupObjectivePanel(self) -> QGridLayout:
        ...
        def objChanged():
            ...
            # self.targetD.valueChanged.emit(0) #Trigger the targChanged() function. Not sure what the number should be or if it matters.
        ...
        gl.addWidget(self.measureObjectiveButton, 3, 0, 1, 3)
        return gl
    ...
    def setupMeasurePanel(self) -> QGridLayout:
        ...
        gl.addWidget(self.measureApertureButton, 3, 0, 1, 3)
        return gl
    ...
    def setupTargetPanel(self) -> QGridLayout:
        ...
        def updateOverlay():
            ...
            self.measuredOverlay.x = self.targetX.value() #self._measCenter[0]
            self.measuredOverlay.y = self.targetY.value() #self._measCenter[1]
        ...
        gl.addWidget(self.centerTargetButton, 3, 0, 1, 3)
        return gl
